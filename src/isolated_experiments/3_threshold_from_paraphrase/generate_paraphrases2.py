...
"""
This template generates same (or almost same) text, but changes the entities
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Paraphrases2")
    ...
    for line in data:
        ...
        work_data.append(template2.substitute(**template_data))
