...
CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    ...
    --quit_training_prematurely_flag --quit_training_prematurely_steps 5000 \
    ...
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a1.jsonl --fp16

CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    --model_rule_lr 3e-5 --model_sentence_lr 1e-5 --head_lr 1e-4 --logit_scale_lr 3e-4 --max_epochs 3 --train_batch_size 512 --val_batch_size 64 --gradient_clip_val 5.0 --dropout 0.1 --projection_dims 384 --weight_decay 0.001 \
    --run_description "Param search" \
    --random_data_which_preprocessing_step_to_use 3 \
    --gradient_checkpointing_enable \
    --rules_path \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/enhanced_syntax.jsonl" \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/surface.jsonl" \
    ...
    --preprocessing_type typed_entity_marker_punct_v2 \
    --val_check_interval_int 2000 --accumulate_grad_batches 1 --show_progress --max_steps 100000 \
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a2.jsonl --fp16

CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    --model_rule_lr 3e-5 --model_sentence_lr 1e-5 --head_lr 1e-4 --logit_scale_lr 3e-4 --max_epochs 3 --train_batch_size 512 --val_batch_size 64 --gradient_clip_val 5.0 --dropout 0.1 --projection_dims 384 --weight_decay 0.001 \
    --run_description "Param search" \
    --random_data_which_preprocessing_step_to_use 2 \
    --gradient_checkpointing_enable \
    --rules_path \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/enhanced_syntax.jsonl" \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/surface.jsonl" \
    ...
    --preprocessing_type typed_entity_marker_punct_v2 \
    --val_check_interval_int 2000 --accumulate_grad_batches 1 --show_progress --max_steps 100000 \
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a3.jsonl --fp16

CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    --model_rule_lr 3e-5 --model_sentence_lr 1e-5 --head_lr 1e-4 --logit_scale_lr 3e-4 --max_epochs 3 --train_batch_size 512 --val_batch_size 64 --gradient_clip_val 5.0 --dropout 0.1 --projection_dims 384 --weight_decay 0.001 \
    --run_description "Param search" \
    --random_data_which_preprocessing_step_to_use 1 \
    --gradient_checkpointing_enable \
    --rules_path \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/enhanced_syntax.jsonl" \
        "/storage/rvacareanu/data/softrules/rules/fsre_dataset/TACRED/surface.jsonl" \
    ...
    --preprocessing_type typed_entity_marker_punct_v2 \
    --val_check_interval_int 2000 --accumulate_grad_batches 1 --show_progress --max_steps 100000 \
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a4.jsonl --fp16
...
CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    ...
    --random_data_which_preprocessing_step_to_use 4 \
    --gradient_checkpointing_enable \
    --esp_duplicate 0 --sp_duplicate 0 \
    ...
    --preprocessing_type typed_entity_marker_punct_v2 \
    --val_check_interval_int 2000 --accumulate_grad_batches 1 --show_progress --max_steps 100000 \
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a5.jsonl --fp16
...
CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.model_cliplike --model_name_or_checkpoint_rule 'roberta-large' --model_name_or_checkpoint_sentence 'roberta-large' --how_many_rules_to_average 1\
    ...
    --preprocessing_type typed_entity_marker_punct_v2 \
    --val_check_interval_int 2000 --accumulate_grad_batches 1 --show_progress --max_steps 100000 \
    --append_results_to_file /storage/rvacareanu/code/projects_7_2309/softrules/results/231211/final_run_ablations/logs_settings_ps_a6.jsonl --fp16
