...
CUDA_VISIBLE_DEVICES=0 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.eval_interventions \
    ...
    --rules_path \
        "intervention_data/annotator1/enhanced_syntax.jsonl" \
    --dev_path \
    ...
    --default_preds_path \
        "intervention_data/annotator1/default_predictions/dev_k1_s90_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k1_s91_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k1_s92_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k1_s93_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k1_s94_rt_es_t0.json" \
    --append_results_to_file \
        "results/231213/interventions/intervention1_strictthreshold/tacred_dev_1.jsonl" > results/231213/interventions/intervention1_strictthreshold/tacred_dev_1.txt
...
CUDA_VISIBLE_DEVICES=0 TOKENIZERS_PARALLELISM=true python -m src.softrules.different_encoder.eval_interventions \
    ...
    --default_preds_path \
        "intervention_data/annotator1/default_predictions/dev_k5_s90_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k5_s91_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k5_s92_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k5_s93_rt_es_t0.json" \
        "intervention_data/annotator1/default_predictions/dev_k5_s94_rt_es_t0.json" \
    --append_results_to_file \
        "results/231213/interventions/intervention1_strictthreshold/tacred_dev_5.jsonl" > results/231213/interventions/intervention1_strictthreshold/tacred_dev_5.txt
